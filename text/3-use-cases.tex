...
% TODO: Still not doing arid
The term \textit{cloud detection} was used together with terms \textit{arid} and \textit{desert} in the search phrase for this use case. Also a search phrase with \textit{cloud detection} solely was used to maximize the grasp of the research. This research was done in April 2021.
