...
\title[]{Možnosti využití konvolučních neuronových sítí pro obrazovou klasifikaci v dálkovém průzkumu Země} % The short title appears at the bottom of every slide, the full title is only on the title page
